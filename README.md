...
- **AI mô tả ngoại hình nhân vật từ ảnh** (nút "✨ AI mô tả ngoại hình từ ảnh" ở tab Nhân vật): vì Cloudflare AI/Pollinations (2 nguồn tạo ảnh miễn phí) không xem được ảnh mẫu của nhân vật, AI sẽ "nhìn" ảnh mẫu và tự viết ra một đoạn mô tả ngoại hình chi tiết bằng chữ (tóc, dáng người, trang phục, đặc điểm riêng…) điền thẳng vào ô "Đặc điểm cần đồng nhất" — mô tả này sau đó được dùng lại tự động ở mọi nơi (viết prompt phân cảnh, chia phân đoạn, tạo ảnh bằng Cloudflare/Pollinations/Gemini), giúp ảnh tạo ra bám sát ngoại hình nhân vật hơn
